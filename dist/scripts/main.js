...
// Render projects UI
renderComponent("projects", {src: "./images/pp.jpg", project_name: "Graph2Code", project_des: "A simple web app which features a simple way to design html elements and also access their equivalent HTML/CSS codes on the go.", href: "https://graph2code.vercel.app"}, "#projects");
